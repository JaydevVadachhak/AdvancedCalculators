 ...
 * @author PREMIUM
 */
public class RemoveGST extends JFrame implements ActionListener {
    ...
    RemoveGST(){
        ...
        l1 = new JLabel("Pramukh Calculators - Remove GST");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==b1){
            if(t3.getText().equals("")){
                ...
                if(GST.equals("3%")){
                    GSTAmount = ((OriginalPrice*(100+3))-(OriginalPrice*100))/(100+3);
                    ...
                    GSTAmount = ((OriginalPrice*(100+5))-(OriginalPrice*100))/(100+5);
                    FinalPrice = OriginalPrice - GSTAmount;
                    SGST = GSTAmount/2;
                    t5.setText(String.valueOf(GSTAmount));
                    t6.setText(String.valueOf(FinalPrice));
                    ...
                    GSTAmount = ((OriginalPrice*(100+12))-(OriginalPrice*100))/(100+12);
                    FinalPrice = OriginalPrice - GSTAmount;
                    SGST = GSTAmount/2;
                    t5.setText(String.valueOf(GSTAmount));
                    t6.setText(String.valueOf(FinalPrice));
                    ...
                    GSTAmount = ((OriginalPrice*(100+18))-(OriginalPrice*100))/(100+18);
                    FinalPrice = OriginalPrice - GSTAmount;
                    SGST = GSTAmount/2;
                    t5.setText(String.valueOf(GSTAmount));
                    t6.setText(String.valueOf(FinalPrice));
                    ...
                    GSTAmount = ((OriginalPrice*(100+28))-(OriginalPrice*100))/(100+28);
                    FinalPrice = OriginalPrice - GSTAmount;
                    SGST = GSTAmount/2;
                    t5.setText(String.valueOf(GSTAmount));
                    t6.setText(String.valueOf(FinalPrice));
